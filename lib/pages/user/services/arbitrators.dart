...
class UserArbitrator extends StatefulWidget {
  const UserArbitrator({Key? key}) : super(key: key);

  @override
  State<UserArbitrator> createState() => _UserArbitratorState();
}

class _UserArbitratorState extends State<UserArbitrator> {
          ...
          children: [
            ...
            TextButton(
              onPressed: () => Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => ArbitratorList(
                    state: selectedState,
